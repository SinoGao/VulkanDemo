...
namespace SeaTone{
    VulkanPipeLine::VulkanPipeLine(std::tuple<VkPhysicalDevice, VkDevice, VkCommandPool, VkQueue> param)
    {
        std::tie(this->physicalDevice, this->logicalDevice, this->commandPool, this->graphicsQueue) = param;
        int i = 0;
    }
    ...
    void VulkanPipeLine::createVertexBuffer(const std::vector<VulkanVertex> verts)
	{
    ...
    void VulkanPipeLine::createIndexBuffer(const std::vector<uint16_t> indices)
    {
